...
import os
newcon_name="默认空箺" #默认误删
con_name="回归" #默认误删
cpath = PATH("..\config\yaml\jyb\jybcase1.yaml")   #默认误删
pc_type="android真机" #默认误删
pc_ip="127.0.0.1" #默认误删
getparam={'parama': '42010000200', 'paramb': '电脑', 'paramc': '即享贷A', 'paramd': '4000', 'parame': '1000', 'paramf': '百宝箱', 'paramg': '6', 'paramh': '台式电脑', 'parami': '苹果', 'paramj': '不参加', 'paramk': 'P2P_PPM', 'paraml': 'r', 'paramm': 'test1'} #默认误删
uname="300079" #默认误删
markval="300079_2_1"#默认误删
